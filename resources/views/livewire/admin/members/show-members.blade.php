<div>
    <a class="p-2 rounded-lg bg-white hover:bg-slate-100 transition-all" href="{{ route('admin.members.add') }}">Add Member</a>
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                @foreach ($members as $row)
                    <tr class="{{$row->membership_status == 'active'? 'bg-white':'bg-red-300 '}} border-b">
                        ...
                        <td class="px-6 py-4 text-right">
                            <a href="{{ route('admin.members.edit', ['id'=>$row->id]) }}"
