<div>
    <div class="flex border-4 h-screen justify-center items-center">
        <form class="w-4/5 md:w-1/2 mx-auto my-auto shadow-2xl p-5 rounded-xl">
            <div class="w-20 m-auto my-5">
                <img src="https://www.svgrepo.com/show/241609/strongman.svg" alt="">
            </div>
            <div class="mb-5">
